...
4. Restore the alignment selected for the actual board installation and save it.
5. Perform one new compass calibration. Do not reuse calibration produced by
   4.0.2 because it was stamped for the old alignment contract.
6. Check north, east, south and west while the board is level, then repeat the
