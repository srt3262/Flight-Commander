...
- Minor and patch versions may differ within a major release train.
...
`flightCommander.firmwareMajor: 2`. The test suite runs
`scripts/check-flight-commander-version.mjs` and rejects a mismatched package.
