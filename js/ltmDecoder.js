...
const ltmDecoder = (function () {
    ...
    privateScope.readInt = function (offset) {
        const value = privateScope.serialBuffer[offset] + (privateScope.serialBuffer[offset + 1] << 8);
        return value & 0x8000 ? value - 0x10000 : value;
    }

    privateScope.readUint16 = function (offset) {
            ...
            if (privateScope.receiverIndex == privateScope.frameLength - 4) {
                ...
                */
                ...
                if (privateScope.frameType == 'S') {
                    TELEMETRY.voltage = privateScope.readUint16(0);
                    TELEMETRY.consumedMah = privateScope.readUint16(2);
                    TELEMETRY.currectDrawn = TELEMETRY.consumedMah;
                    ...
                    TELEMETRY.armed = Boolean(fm & 0x01);
                    TELEMETRY.failsafe = Boolean(fm & 0x02);
                }
                ...
                if (privateScope.frameType == 'N') {
                    TELEMETRY.navigationMode = privateScope.readByte(0);
                    TELEMETRY.navigationState = privateScope.readByte(1);
                    TELEMETRY.navigationAction = privateScope.readByte(2);
                    TELEMETRY.activeWaypointNumber = privateScope.readByte(3);
                    TELEMETRY.navigationError = privateScope.readByte(4);
                }

                if (privateScope.frameType == 'O') {
                    TELEMETRY.homeLatitude = privateScope.readInt32(0);
                    TELEMETRY.homeLongitude = privateScope.readInt32(4);
                    TELEMETRY.homeAltitude = privateScope.readInt32(8);
                }
