...
/*
 * ArduPilot ROTATION_YAW_90 maps to CW270_DEG_FLIP because the
 * ArduPilot-to-Flight
 * Commander sensor-driver convention adds a 180-degree roll.
 */
BUSDEV_REGISTER_SPI_TAG(cube_imu0_icm42688, DEVHW_ICM42605, BUS_SPI4, PC15, NONE, 0, DEVFLAGS_NONE, CW270_DEG_FLIP);
BUSDEV_REGISTER_SPI_TAG(cube_imu0_icm45686, DEVHW_ICM45686, BUS_SPI4, PC15, NONE, 0, DEVFLAGS_NONE, CW270_DEG_FLIP);

/* ArduPilot ROTATION_PITCH_180_YAW_90 maps to CW270_DEG. */
BUSDEV_REGISTER_SPI_TAG(cube_imu1_icm42688, DEVHW_ICM42605, BUS_SPI4, PC13, NONE, 1, DEVFLAGS_NONE, CW270_DEG);
BUSDEV_REGISTER_SPI_TAG(cube_imu1_icm45686, DEVHW_ICM45686, BUS_SPI4, PC13, NONE, 1, DEVFLAGS_NONE, CW270_DEG);
