...
#define UBLOX_CFG_MSGOUT_NAV_RELPOSNED_UART1 0x2091008e // U1
...
typedef struct {
    ...
    uint32_t time;
    int32_t relative_north;
    int32_t relative_east;
    int32_t relative_down;
    int32_t relative_length;
    int32_t relative_heading;
    uint8_t reserved1[4];
    int8_t relative_hp_north;
    int8_t relative_hp_east;
    int8_t relative_hp_down;
    int8_t relative_hp_length;
    uint32_t accuracy_north;
    uint32_t accuracy_east;
    uint32_t accuracy_down;
    uint32_t accuracy_length;
    uint32_t accuracy_heading;
    uint8_t reserved2[4];
    uint32_t flags;
} __attribute__((packed)) ubx_nav_relposned;

STATIC_ASSERT(sizeof(ubx_nav_relposned) == 64, wrong_ubx_nav_relposned_size);
