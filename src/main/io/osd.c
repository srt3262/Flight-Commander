...
static const char * osdArmingDisabledReasonMessage(void)
{
    ...
    switch (isArmingDisabledReason()) {
        ...
        case ARMING_DISABLED_DRONECAN_BRIDGE:
            return OSD_MESSAGE_STR(OSD_MSG_DRONECAN_BRIDGE);
...
{
    // Preserve the established numeric positions used by Blackbox and other tools.
    const char * disarmReasonStr[DISARM_REASON_COUNT] = { "UNKNOWN", "TIMEOUT", "STICKS", "SWITCH", "SWITCH", "GCS", "FAILSAFE", "NAV SYS", "LANDING"};
