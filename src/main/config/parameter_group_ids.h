...
#define PG_FLIGHT_COMMANDER_HEADING_CONFIG 1046
#define PG_FLIGHT_COMMANDER_COMPASS_ORIENTATION 1047
#define PG_FLIGHT_COMMANDER_DSHOT_CONFIG 1048
#define PG_INAV_END PG_FLIGHT_COMMANDER_DSHOT_CONFIG
