...
#define PRIMARY_MODE_ACTIVE_OR_SELECTED(mode, box) \
    (FLIGHT_MODE(mode) || isRcModeActiveFromInput(box))
#else
#define PRIMARY_MODE_ACTIVE_OR_SELECTED(mode, box) FLIGHT_MODE(mode)
#endif
...
void packBoxModeFlags(boxBitmask_t * mspBoxModeFlags)
{
    ...
    CHECK_ACTIVE_BOX(IS_ENABLED(PRIMARY_MODE_ACTIVE_OR_SELECTED(ANGLE_MODE, BOXANGLE)), BOXANGLE);
    ...
    CHECK_ACTIVE_BOX(IS_ENABLED(PRIMARY_MODE_ACTIVE_OR_SELECTED(NAV_ALTHOLD_MODE, BOXNAVALTHOLD)), BOXNAVALTHOLD);
    CHECK_ACTIVE_BOX(IS_ENABLED(PRIMARY_MODE_ACTIVE_OR_SELECTED(NAV_POSHOLD_MODE, BOXNAVPOSHOLD)), BOXNAVPOSHOLD);
    ...
    CHECK_ACTIVE_BOX(IS_ENABLED(PRIMARY_MODE_ACTIVE_OR_SELECTED(NAV_RTH_MODE, BOXNAVRTH)), BOXNAVRTH);
    CHECK_ACTIVE_BOX(IS_ENABLED(PRIMARY_MODE_ACTIVE_OR_SELECTED(NAV_WP_MODE, BOXNAVWP)), BOXNAVWP);
