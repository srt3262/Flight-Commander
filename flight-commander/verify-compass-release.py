#!/usr/bin/env python3
"""Structural verification for Flight Commander 4.3.0 release images."""
...
EXPECTED_IDENTITY = b"FCFW" + bytes((1, 4, 3, 0, 9, 1, 0, 0xFF, 0xFF, 0x01, 0))
TARGET_CONTRACTS = {
    "MICOAIR743": {
        "base": 0x08000000,
...
def main() -> int:
    ...
    if not contains(memory, EXPECTED_IDENTITY):
        fail("HEX does not contain the Flight Commander 4.3.0 identity and 0x0001ffff capability mask")
    ...
    print(f"Verified Flight Commander 4.3.0 {target} HEX: {path}")
