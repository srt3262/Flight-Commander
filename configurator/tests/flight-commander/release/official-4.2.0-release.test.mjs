...
test("4.2.3 retains the verified 4.2.0 Firmware targets", () => {
  assert.equal(packageJson.version, "4.2.3");
...
test("official publisher creates a verified non-prerelease 4.2.3 bundle", () => {
