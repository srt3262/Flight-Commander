...
if (sourcePackage.version !== "4.2.2") {
  fail(`source version is ${sourcePackage.version}; expected 4.2.2`);
}
...
if (
  ...
  fail("Flight Commander 4.2.2 must declare both official firmware targets");
}
if (sourcePackage.flightCommander?.firmwareChangedInRelease !== false) {
  fail("Flight Commander 4.2.2 must retain the unchanged Firmware 4.2.0 targets");
}
if (sourcePackage.flightCommander?.firmwareSourceVersion !== "4.2.0") {
  fail("Flight Commander 4.2.2 must include the Firmware 4.2.0 source archive");
}
