...
BASE_SOURCE_SHA256 = "3d5abf0f09b9cd8dc2e5c36c7b27bed436b487c59f135517bebc386161200d3a"
PATCH_SHA256 = "d562cd4f4b42a44e1c78c79c6a988aa1330d5cf9014bee5ab49662e7d3364bfa"
TARGET = "MICOAIR743"
...
def build(workspace: Path, work: Path, update_repository: bool, prepare_only: bool) -> dict[str, object]:
    ...
    with zipfile.ZipFile(source_output) as archive:
        if archive.testzip() is not None:
            raise RuntimeError("Generated 4.0.8 firmware source archive failed integrity testing")
